...
### 3、注意事项
- **可以**使用任何开源的预训练语言模型如mBERT、XLM-R、mT5等，但需要在提交系统结果时，“系统描述—外部技术说明”部分注明使用何种预训练模型以及相应参数配置；
- **可以**使用除了官方提供的单语语料以外的任何开源单语语料，但需要在提交系统结果时，“系统描述—训练数据说明”注明使用哪些开源数据以及语料大小、tokens数，分语种说明清楚；
