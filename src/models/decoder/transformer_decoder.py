...
from src.utils.utility import freeze_params, load_pretrain_embedding, Embedding, subsequent_mask
...
class TransformerDecoder(nn.Module):
    ...
    def __init__(self, model_config, vocab):
        ...
        self.pe = positional_encoding(self.embedd_size, model_config.get('max_seq_length', 512),\
